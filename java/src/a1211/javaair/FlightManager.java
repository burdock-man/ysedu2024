...
public class FlightManager {
    private static ArrayList<Flight> flights; // 항공편성정보를 저장하는 ArrayList
    private static ArrayList<Passenger> passengers; // 예약된 승객 정보를 저장하는 ArrayList
    // key = 승객 | value = 예약된항공편 을 가지는 Map
    ...
    public void displayFlightList(String str) {
        // 항공편 목록 출력 메소드 -> flight 에서 toString 이용
    ...
    public void bookFlight() throws InterruptedException {
        // 국제선 - 사용자이름, 생년월일 받아서 나이 확인하고 만 15세 미만은 예약거절
        for(;;) { // 무한루프
    ...
    private void passengerInfo(Flight flights) {
        ...
        try {
            ...
            if(!p.man15(p) && flights.getInternationalFlight()) {
                // 왼쪽과 오른쪽이 true여야 실행
                // 만 15세 검증하는거
            ...
            System.out.println("생년월일을 6자리로 입력해주세요. ex) 900123");
        }
    }
