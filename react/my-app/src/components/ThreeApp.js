  ...
  return (
    <div>
      ...
      <div className='d-inline-flex'>
        ...
        placeholder='0000' onChange={(e) => {handlePhoneChange(e, 'hp2')}} value={phone.hp2}/>
        &nbsp;&nbsp;<b>-</b>&nbsp;&nbsp;
        <input type='text' maxLength={4} className='form-control' style={{width: "120px"}}
        placeholder='0000' onChange={(e) => {handlePhoneChange(e, 'hp3')}} value={phone.hp3}/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <b>이미지 선택 : </b>&nbsp;&nbsp;
        <select className='form-contol' style={{width: "100px"}}
      ...
      style={{maxWidth:"100%"}}/> {/* 인덱스번호는 0번부터 시작이니깐~ */}
